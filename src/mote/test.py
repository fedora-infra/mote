json_data = {
    ...
    "Extra Packages for Enterprise Linux(EPEL)": ["epel meeting"],
    ...
    "Fedora Badges Team": ["badges team meeting", "Fedora Badges Bug Triage Session"],
    ...
    "Fedora Design Team": ["fedora-design team meeting"],
    "Fedora Diversity & Inclusion Team": ["Fedora Diversity Meeting"],
    ...
    "Fedora Engineering Steering Committee(FESCo)": ["fesco team meeting"],
    "Fedora Globalization (G11n) Team": ["g11n team meeting"],
    "Fedora Infrastructure Team": [
        "Fedora Infrastructure Ops Daily Standup Meeting",
        "infrastructure team meeting",
    ],
    "Fedora Internationalization(i18n) Team": ["i18n team meeting"],
    ...
    "Fedora Packaging Committee(FPC)": ["fpc team meeting"],
    "Fedora Quality Assurance(QA)": [
        "fedora-qa team meeting",
        "Special Fedora QA Wireplumber Meeting",
    ],
    "Fedora Release Engineering(releng)": ["releng team meeting"],
    "Fedora Zhongwen User Group(FZUG)": ["fzug team meeting"],
    "LATAM Ambassadors(Latin America) Group": ["fedora_latam_ambassadors_meeting"],
    "NA Ambassadors(North America)": ["famna team meeting"],
    "Project Leadership Team": ["fedora_council team meeting"],
}
